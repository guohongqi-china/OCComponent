...
#import "UITextField+VNCategory.h"
#import <objc/runtime.h>

@implementation UITextField (VNCategory)

+ (instancetype)createView:(void(^)(VNPropertyManager *manager))block{
    UITextField *view               = [[self alloc]init];
    VNPropertyManager *manager      = [VNPropertyManager new];
    manager.chileTextField          = view;
